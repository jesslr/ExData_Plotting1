...
## Create plot 3, sub_metering (3 variables) by DateTime
# start with setting up the plot and then adding the lines with appropriate colors
with(subData, plot(Sub_metering_1 ~ DateTime, type="n", xlab="", ylab="Energy sub metering"))
